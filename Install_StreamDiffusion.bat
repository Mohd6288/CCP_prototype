            ...
            cd /d "C:/Mohammed/CCP_prototype - Copy"
            echo Changed directory to: %CD%
            set "PIP_DISABLE_PIP_VERSION_CHECK=1"
            if not exist "venv" (
                echo Creating Python venv at: "C:/Mohammed/CCP_prototype - Copy\venv"
                "C:\Users\Fatima AlKhalifa\AppData\Local\Programs\Python\Python310\python.exe" -m venv venv
            ) else (
                echo Virtual environment already exists at: "C:/Mohammed/CCP_prototype - Copy\venv"
            )
            ...
            if "%VIRTUAL_ENV%" == "" (
                ...
                echo Path to venv: "C:/Mohammed/CCP_prototype - Copy\venv"
            ...
            python -m pip install -r streamdiffusionTD/requirements_pc.txt
